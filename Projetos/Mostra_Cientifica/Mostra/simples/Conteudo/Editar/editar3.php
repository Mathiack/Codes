    ...
    <div class="container">
        ...
        <form action="../verAcoes.php" method="post">
            <div class="form-group">
                ...
                <input type="text" id="titulo" name="titulo" value="Prova" required>
            </div>
            <div class="form-group">
                <label for="descricao">Descrição</label>
                <textarea id="descricao" name="descricao" required>Ajudei meus amigos a estudar para a prova.</textarea>
            </div>
            <div class="form-group">
                <label>Sentimento</label>
                <div class="radio-group">
                    <label><input type="radio" name="sentimento" value="feliz" required> Feliz</label>
                    <label><input type="radio" name="sentimento" value="neutro" checked required> Neutro</label>
